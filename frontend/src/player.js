...
import "./player.css"; // Import your CSS file for styling
...
function Player() {
  ...
  return (
    <div className="player-container">
      <h1 className="player-header">Spotify Player</h1>
      {profile ? (
        <div>
          {deviceId ? (
            ...
            <div className="search-results">
              ...
              {searchResults.map((track) => (
                <div key={track.id} className="track-card">
                  <img src={track.album.images[0]?.url} alt="Album" width={60} />
                  ...
                  <button
                    onClick={() => {
                      playMusic(token, deviceId, track.uri);
                  ...
                  {playingTrackId === track.id && <PlayingBars />}
